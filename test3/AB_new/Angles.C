...
void Angles::Begin(TTree * /*tree*/)
{
  ...
  // Spin_0p_A = new TTree("Spin_0p_A","Spin_0p_A Tree with variables for TMVA analysis");
 
   // Creating the branches
   // Replace "Spin_0m" with "Spin_0p" when writing the Spin_0p tree to TFile f
   Spin_0p->Branch("cth1",&cth1,"cth1/F");
   Spin_0p->Branch("cth2",&cth2,"cth2/F");
   Spin_0p->Branch("phi",&phi,"phi/F");
   Spin_0p->Branch("m12",&m12,"m12/F");   
   Spin_0p->Branch("m34",&m34,"m34/F");
